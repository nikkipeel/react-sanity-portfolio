            ...
            <section className="container mx-auto">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {projectData?.map((project, index) => (
                        <article className="relative bg-white text-brown rounded-lg shadow-xl py-8 px-12 md:p-16">
                            ...
                            <div className="flex flex-col md:block text-base text-brown"> {/* space-x-4 */}
                                ...
                                <a href={project.link} alt="project link" rel="noopener noreferrer" target="_blank" className="text-pink text-base font-bold hover:underline hover:text-pink-600">
                                    Visit Site {" "}
